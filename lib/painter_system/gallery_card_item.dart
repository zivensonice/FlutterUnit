              ...
              Hero(
                ...
                child: Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(fit: BoxFit.cover, image: AssetImage(galleryInfo.image)),
...
class GalleryInfo {
  ...
  const GalleryInfo({this.count = 0, required this.name, required this.info, required this.image, required this.router});
